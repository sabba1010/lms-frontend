          ...
          <div className="p-4 px-6 border-t border-slate-100 flex flex-col gap-4">
             <div className="flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0">
                   <p className="text-sm font-bold text-dark truncate">Alex Johnson</p>
                   <button onClick={() => setActiveTab('Edit Account')} className="text-[11px] font-bold text-primary hover:underline">View Profile</button>
                </div>
             </div>
             <button 
