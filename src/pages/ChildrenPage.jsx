...
const ChildrenPage = () => {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Banner Section matching screencapture */}
      <section 
        className="relative pt-44 pb-28 text-center bg-cover bg-center bg-no-repeat"
        style={{ backgroundImage: `url(${sectionBg})` }}
      >
        <div className="relative z-10">
          <h1 className="text-[52px] font-black text-[#1B2336] mb-4 tracking-tight">Children</h1>
      ...
      {/* Courses Section */}
      <CoursesSection initialCategory="children" showFilters={true} />
